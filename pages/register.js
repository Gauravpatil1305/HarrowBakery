...
const Register = () => {
  ...
  return (
    <div className="w-full relative bg-grayscale-white h-[1721px] overflow-hidden text-left text-lg text-grayscale-white font-quicksand">
      <div
        className="absolute top-[861px] left-[69px] flex flex-col items-start justify-start [&.animate]:animate-[1s_ease_0s_1_normal_forwards_scale-up] opacity-[1] text-center text-16xl text-darkorange-600 font-pacifico"
        data-animate-on-scroll
      >
      ...
      <div className="absolute top-[1458px] left-[0px] w-[1440px] h-[263px] text-black font-pacifico">
        <div
      ...
      <img
        ...
        src="/group-3@2x.png"
      />
      <div className="absolute top-[274px] left-[486px] box-border w-[342px] h-[42px] overflow-hidden text-xl text-gainsboro-200 font-rubik border-[1px] border-solid border-miscellaneous-floating-tab-text-selected">
        <div className="absolute top-[9px] left-[10px] capitalize inline-block w-[300px] h-[23px]">
          Full Name
        </div>
      </div>
      <div className="absolute top-[346px] left-[486px] box-border w-[342px] h-[42px] overflow-hidden text-xl text-gainsboro-200 font-rubik border-[1px] border-solid border-miscellaneous-floating-tab-text-selected">
        <div className="absolute top-[9px] left-[10px] capitalize inline-block w-[300px] h-[23px]">
          Email
        </div>
      </div>
      <div className="absolute top-[418px] left-[486px] box-border w-[342px] h-[42px] overflow-hidden text-xl text-gainsboro-200 font-rubik border-[1px] border-solid border-miscellaneous-floating-tab-text-selected">
        <div className="absolute top-[9px] left-[10px] capitalize inline-block w-[300px] h-[23px]">
          phone
        </div>
      </div>
      <div className="absolute top-[490px] left-[486px] box-border w-[342px] h-[42px] overflow-hidden text-xl text-gainsboro-200 font-rubik border-[1px] border-solid border-miscellaneous-floating-tab-text-selected">
        <div className="absolute top-[9px] left-[10px] capitalize inline-block w-[300px] h-[23px]">
          Set passward
        </div>
      </div>
      <div className="absolute top-[590px] left-[572px] rounded-2xl box-border w-[149px] h-[42px] overflow-hidden text-xl text-black font-rubik border-[1px] border-solid border-miscellaneous-floating-tab-text-selected">
        <b className="absolute top-[9px] left-[36px] capitalize inline-block w-[78px] h-[23px]">
          SUBMIT
        </b>
      </div>
