...
const Cart = () => {
  ...
  const onBasketContainerClick1 = useCallback(() => {
  ...
  return (
    <div className="w-full relative bg-grayscale-white h-[2246px] overflow-hidden text-left text-lg text-grayscale-white font-quicksand">
      <div
        className="absolute top-[1362px] left-[69px] flex flex-col items-start justify-start [&.animate]:animate-[1s_ease_0s_1_normal_forwards_scale-up] opacity-[1] text-center text-16xl text-darkorange-600 font-pacifico"
        data-animate-on-scroll
      >
      ...
      <b className="absolute top-[158px] left-[0px] text-29xl capitalize inline-block w-[1440px] h-[74px] text-black">
        <span className="whitespace-pre-wrap">{`                                   `}</span>
        <span className="text-darkorange-400 whitespace-pre-wrap">
          {" "}
          SHOPPING CART
        </span>
      </b>
      <b className="absolute top-[393px] left-[162px] text-17xl capitalize inline-block text-black w-[610px] h-[100px]">
        Your cart is empty
      </b>
      <img
        className="absolute top-[429px] left-[552px] w-[408px] h-[295px] object-cover"
        alt=""
        src="/image-1@2x.png"
      />
      <div className="absolute top-[0px] left-[8px] text-13xl capitalize font-pacifico inline-block w-[244px] h-[66px]">
        Harrow bakery
      </div>
      <div
        className="absolute top-[-1px] left-[calc(50%_-_720px)] bg-darkorange-1000 w-[1440px] h-[93px] flex flex-row items-center justify-center py-[25px] px-[66px] box-border gap-[104px] text-sm font-segoe-ui"
      ...
      <div className="absolute top-[-1px] left-[calc(50%_-_720px)] bg-darkorange-1000 w-[1440px] h-[93px] flex flex-row items-center justify-center py-[25px] px-[66px] box-border gap-[104px] text-sm font-segoe-ui">
        ...
        <div className="flex-1 flex flex-row items-center justify-end gap-[22px] font-rubik">
          ...
          <div
            className="rounded-7xl bg-darkorange-300 flex flex-row items-center justify-center py-2.5 px-[26px] gap-[15px] cursor-pointer"
            onClick={onBasketContainerClick1}
          >
            <b className="relative capitalize">basket (0)</b>
            <img
              className="w-6 relative h-6 overflow-hidden shrink-0"
