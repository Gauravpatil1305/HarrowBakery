...
const SHOP = () => {
  ...
  return (
    <div className="w-full relative bg-grayscale-white h-[2439px] overflow-hidden text-left text-5xl text-grayscale-white font-quicksand">
      <b
        className="absolute top-[131px] left-[27px] text-17xl tracking-[-1.2px] leading-[72px] capitalize text-black text-center"
        data-scroll-to="categoryText"
      >
        category
      </b>
      <div
        className="absolute top-[226px] left-[30px] bg-grayscale-white flex flex-row items-center justify-center gap-[16px] cursor-pointer text-base text-black"
      ...
      <div className="absolute top-[508px] left-[30px] bg-grayscale-white flex flex-row items-center justify-center gap-[16px] text-base text-black">
        <div className="w-12 h-12 flex flex-row items-center justify-center">
          <div className="rounded-81xl flex flex-row items-center justify-center p-[11px] relative">
            <div className="w-[18px] relative rounded-sm bg-lightgray h-[18px] z-[0]" />
            <img
      ...
      <div className="absolute top-[368px] left-[30px] bg-grayscale-white flex flex-row items-center justify-center gap-[16px] text-base text-black">
        <div className="w-12 h-12 flex flex-row items-center justify-center">
          <div className="rounded-81xl flex flex-row items-center justify-center p-[11px] relative">
            <div className="w-[18px] relative rounded-sm bg-lightgray h-[18px] z-[0]" />
            <img
      ...
      <div className="absolute top-[297px] left-[30px] bg-grayscale-white flex flex-row items-center justify-center gap-[16px] text-base text-black">
        <div className="w-12 h-12 flex flex-row items-center justify-center">
          <div className="rounded-81xl flex flex-row items-center justify-center p-[11px] relative">
            <div className="w-[18px] relative rounded-sm bg-lightgray h-[18px] z-[0]" />
            <img
      ...
      <div className="absolute top-[579px] left-[96px] flex flex-row items-center justify-start gap-[12px] text-base text-black">
        <div className="w-10 relative rounded-xl bg-gainsboro-200 h-10 hidden" />
        <div className="w-[148px] flex flex-row items-center justify-center gap-[53px]">
          <div className="flex-1 relative tracking-[-1.2px] capitalize font-medium">
            donut
      ...
      <div className="absolute top-[437px] left-[30px] bg-grayscale-white flex flex-row items-center justify-center gap-[16px] text-base text-black">
        <div className="w-12 h-12 flex flex-row items-center justify-center">
          <div className="rounded-81xl flex flex-row items-center justify-center p-[11px] relative">
            <div className="w-[18px] relative rounded-sm bg-lightgray h-[18px] z-[0]" />
            <img
      ...
      <div className="absolute top-[169px] left-[1258px] rounded-xl bg-darkorange-300 flex flex-row items-center justify-center py-[11.5px] px-6 text-sm font-rubik">
        <b className="relative capitalize">sort by : default</b>
      </div>
      <div className="absolute top-[288px] left-[372px] rounded-3xs bg-chocolate-100 flex flex-col items-center justify-center pt-0 px-0 pb-[22px] gap-[22px] text-center">
        <img
      ...
      <div className="absolute top-[1802px] left-[1108px] rounded-3xs bg-chocolate-100 flex flex-col items-center justify-center pt-0 px-0 pb-[22px] gap-[22px] text-center">
        <img
          className="w-[303px] relative rounded-t-3xs rounded-b-none h-[233px] object-cover z-[0]"
          alt=""
          src="/rectangle-305@2x.png"
        />
        <img className="w-5 relative h-5 z-[1]" alt="" src="/vector4.svg" />
        <div className="relative capitalize font-semibold z-[2]">Donut's</div>
        <b className="w-[73px] absolute !m-[0] top-[258px] left-[198px] text-xl capitalize inline-block text-left z-[3]">
          <span>₹120.00</span>
          <span className="text-black">{` `}</span>
      ...
      <div className="absolute top-[1804px] left-[740px] rounded-3xs bg-chocolate-100 flex flex-col items-center justify-center pt-0 px-0 pb-[22px] gap-[22px] text-center">
        <img
          className="w-[303px] relative rounded-t-3xs rounded-b-none h-[233px] object-cover z-[0]"
          alt=""
          src="/rectangle-305@2x.png"
      ...
      <div className="absolute top-[288px] left-[740px] rounded-3xs bg-chocolate-100 flex flex-col items-center justify-center pt-0 px-0 pb-[22px] gap-[22px] text-center">
        <img
          className="w-[303px] relative rounded-t-3xs rounded-b-none h-[233px] object-cover z-[0]"
          alt=""
      ...
      <div className="absolute top-[288px] left-[1108px] rounded-3xs bg-chocolate-100 flex flex-col items-center justify-center pt-0 px-0 pb-[22px] gap-[22px] text-center">
        <img
          className="w-[303px] relative rounded-t-3xs rounded-b-none h-[233px] object-cover z-[0]"
          alt=""
      ...
      <div className="absolute top-[686px] left-[27px] rounded-3xs bg-chocolate-100 flex flex-col items-center justify-center pt-0 px-0 pb-[22px] gap-[22px] text-center">
        <img
          className="w-[303px] relative rounded-t-3xs rounded-b-none h-[233px] object-cover z-[0]"
          alt=""
      ...
      <div className="absolute top-[686px] left-[372px] rounded-3xs bg-chocolate-100 flex flex-col items-center justify-center pt-0 px-0 pb-[22px] gap-[22px] text-center">
        <img
          className="w-[303px] relative rounded-t-3xs rounded-b-none h-[233px] object-cover z-[0]"
          alt=""
      ...
      <div className="absolute top-[1059px] left-[27px] rounded-3xs bg-chocolate-100 flex flex-col items-center justify-center pt-0 px-0 pb-[22px] gap-[22px] text-center">
        <img
          className="w-[303px] relative rounded-t-3xs rounded-b-none h-[233px] object-cover z-[0]"
          alt=""
      ...
      <div className="absolute top-[1424px] left-[27px] rounded-3xs bg-chocolate-100 flex flex-col items-center justify-center pt-0 px-0 pb-[22px] gap-[22px] text-center">
        <img
          className="w-[303px] relative rounded-t-3xs rounded-b-none h-[233px] object-cover z-[0]"
          alt=""
      ...
      <div className="absolute top-[1802px] left-[372px] rounded-3xs bg-chocolate-100 flex flex-col items-center justify-center pt-0 px-0 pb-[22px] gap-[22px] text-center">
        <img
          className="w-[303px] relative rounded-t-3xs rounded-b-none h-[233px] object-cover z-[0]"
          alt=""
      ...
      <div className="absolute top-[686px] left-[740px] rounded-3xs bg-chocolate-100 flex flex-col items-center justify-center pt-0 px-0 pb-[22px] gap-[22px] text-center">
        <img
          className="w-[303px] relative rounded-t-3xs rounded-b-none h-[233px] object-cover z-[0]"
          alt=""
      ...
      <div className="absolute top-[686px] left-[1108px] rounded-3xs bg-chocolate-100 flex flex-col items-center justify-center pt-0 px-0 pb-[22px] gap-[22px] text-center">
        <img
          className="w-[303px] relative rounded-t-3xs rounded-b-none h-[233px] object-cover z-[0]"
          alt=""
          src="/rectangle-303@2x.png"
      ...
      <div className="absolute top-[1059px] left-[372px] rounded-3xs bg-chocolate-100 flex flex-col items-center justify-center pt-0 px-0 pb-[22px] gap-[22px] text-center">
        <img
          className="w-[303px] relative rounded-t-3xs rounded-b-none h-[233px] object-cover z-[0]"
          alt=""
      ...
      <div className="absolute top-[1424px] left-[1108px] rounded-3xs bg-chocolate-100 flex flex-col items-center justify-center pt-0 px-0 pb-[22px] gap-[22px] text-center">
        <img
          className="w-[303px] relative rounded-t-3xs rounded-b-none h-[233px] object-cover z-[0]"
          alt=""
      ...
      <div className="absolute top-[1059px] left-[740px] rounded-3xs bg-chocolate-100 flex flex-col items-center justify-center pt-0 px-0 pb-[22px] gap-[22px] text-center">
        <img
          className="w-[303px] relative rounded-t-3xs rounded-b-none h-[233px] object-cover z-[0]"
          alt=""
      ...
      <div className="absolute top-[1059px] left-[1108px] rounded-3xs bg-chocolate-100 flex flex-col items-center justify-center pt-0 px-0 pb-[22px] gap-[22px] text-center">
        <img
          className="w-[303px] relative rounded-t-3xs rounded-b-none h-[233px] object-cover z-[0]"
          alt=""
      ...
      <div className="absolute top-[1424px] left-[373px] rounded-3xs bg-chocolate-100 flex flex-col items-center justify-center pt-0 px-0 pb-[22px] gap-[22px] text-center">
        <img
          className="w-[303px] relative rounded-t-3xs rounded-b-none h-[233px] object-cover z-[0]"
          alt=""
          src="/rectangle-302@2x.png"
      ...
      <div className="absolute top-[1802px] left-[27px] rounded-3xs bg-chocolate-100 flex flex-col items-center justify-center pt-0 px-0 pb-[22px] gap-[22px] text-center">
        <img
          className="w-[303px] relative rounded-t-3xs rounded-b-none h-[233px] object-cover z-[0]"
          alt=""
          src="/rectangle-302@2x.png"
      ...
      <div className="absolute top-[1428px] left-[740px] rounded-3xs bg-chocolate-100 flex flex-col items-center justify-center pt-0 px-0 pb-[22px] gap-[22px] text-center">
        <img
          className="w-[303px] relative rounded-t-3xs rounded-b-none h-[233px] object-cover z-[0]"
          alt=""
          src="/rectangle-302@2x.png"
      ...
      <div className="absolute top-[2179px] left-[0px] w-[1440px] h-[263px] text-lg text-black font-pacifico">
        <div
      ...
      <div className="absolute top-[99px] left-[527px] flex flex-col items-center justify-center text-center text-16xl text-darkorange-200 font-pacifico">
      ...
      <b className="absolute top-[34px] left-[417px] text-lg capitalize inline-block w-16 h-[21px]">
        Home
      </b>
      <b className="absolute top-[34px] left-[511px] text-lg capitalize inline-block w-16 h-[22px]">
        About
      </b>
      <b className="absolute top-[34px] left-[614px] text-lg capitalize inline-block w-[49px] h-[21px]">
        Shop
      </b>
      <b className="absolute top-[32px] left-[702px] text-lg capitalize inline-block w-[46px] h-5">
        Blog
      </b>
      <b className="absolute top-[34px] left-[778px] text-lg capitalize inline-block w-[78px] h-[25px]">
        Contact
      </b>
      <div className="absolute top-[-1px] left-[calc(50%_-_720px)] bg-darkorange-1000 w-[1440px] h-[93px] flex flex-row items-center justify-center py-[25px] px-[66px] box-border gap-[104px] text-sm font-segoe-ui">
        <div className="w-[498px] hidden flex-row items-center justify-start gap-[10px]">
      ...
      <b
        className="absolute top-[34px] left-[417px] text-lg capitalize inline-block w-16 h-[21px] cursor-pointer"
        onClick={onLogoContainerClick}
      >
        Home
      </b>
      <b
        className="absolute top-[34px] left-[511px] text-lg capitalize inline-block w-16 h-[22px] cursor-pointer"
        onClick={onAboutTextClick}
      >
        About
      </b>
      ...
      <b
        className="absolute top-[32px] left-[702px] text-lg capitalize inline-block w-[46px] h-5 cursor-pointer"
        onClick={onFrameContainerClick}
      >
        Blog
      </b>
      <b
        className="absolute top-[34px] left-[778px] text-lg capitalize inline-block w-[78px] h-[25px] cursor-pointer"
        onClick={onFrameContainerClick1}
      >
        Contact
      </b>
